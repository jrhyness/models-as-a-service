...
All environment variables have corresponding CLI flags. CLI flags override environment variables.
...
| `--tls-min-version` | `TLS_MIN_VERSION` | `1.2` | Minimum TLS version. |
