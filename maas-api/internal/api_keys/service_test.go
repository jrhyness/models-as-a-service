...
func (serviceTestSubSelector) Select(_ []string, _ string, requested string) (*subscription.SelectResponse, error) {
	if requested != "" {
...
func (s subSelectorStub) Select(_ []string, _ string, requested string) (*subscription.SelectResponse, error) {
	if s.selectErr != nil {
